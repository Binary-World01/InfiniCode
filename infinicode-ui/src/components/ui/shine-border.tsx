...
const pricingData: PricingPlan = {
    plan_name: "InfiniCode Pro",
    plan_descp:
        "Scale with confidence using premium AI-powered coding tools, templates, and included strategy guidance.",
    plan_price: 3800,
    plan_feature: [
            ...
            <CardHeader className="p-0">
                <div className="flex flex-col gap-3 self-stretch">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="py-1 px-3 text-sm font-medium leading-5 w-fit h-7 flex items-center gap-1.5">
...
export default function ShineBorderDemo() {
    return (
        <ShineBorder
            borderWidth={2}
            duration={4}
            gradient="from-blue-500 via-purple-500 to-teal-400"
            className="w-fit"
        >
